...
- **`DataTalks Data Engineering/`** — the full Data Engineering Zoomcamp: Docker + Terraform,
  workflow orchestration, data warehousing, batch processing, streaming. See its own
  [README](DataTalks%20Data%20Engineering/README.md).
- **`DataTalks MLOps/`** — the companion MLOps Zoomcamp: experiment tracking, orchestration,
