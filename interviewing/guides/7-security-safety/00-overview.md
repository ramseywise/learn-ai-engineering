...
1. **The core attack** — [prompt-injection.md](../../notes/prompt-injection.md): the
...
3. **Defenses in layers** — [agents-guardrails.md](../../notes/agents-guardrails.md) +
...
4. **Agentic protection** — *Protecting Agentic Systems* (agent-applications book ch 12)
   ...
   `readings/ai_engineering/ai design/`); MCP-specific: librarian *MCP Server Security
   Patterns*.
...
|---|---|---|---|
| prompt-injection.md · security.md · agents-guardrails.md | note | [../../notes/](../../notes/) | the pillar's primary depth (wiki gap) |
| *Building Applications with AI Agents* ch 12 | pdf | `readings/ai_engineering/ai_agent_applications/` | protecting agentic systems |
| *Generative AI Design Patterns* ch 9 | pdf | `readings/ai_engineering/ai design/` | safeguard patterns |
| Constitutional AI (2212.08073) | pdf | `readings/2-llm-rlhf/` | principle-guided harmlessness training |
