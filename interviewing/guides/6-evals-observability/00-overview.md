...
1. **The taxonomy** — [eval-harness.md](../../notes/eval-harness.md) (from Anthropic's
...
2. **Formal methodology** — *AI Engineering* chs 3–4 (Evaluation Methodology, Evaluate AI
   Systems — `readings/ai_engineering/ai engineer/`): the most systematic written
   treatment.
...
5. **Observability in practice** — [observability.md](../../notes/observability.md) +
   langfuse course refs (`generative-ai/coursera-references/`): traces, spans, online
...
|---|---|---|---|
| *AI Engineering* chs 3–4 | pdf | `readings/ai_engineering/ai engineer/` | evaluation methodology end to end |
| *Building Applications with AI Agents* chs 9–11 | pdf | `readings/ai_engineering/ai_agent_applications/` | agent validation, monitoring, improvement loops |
| RAGAS · ARES papers | pdf | `readings/3-rag/` | automated RAG evaluation |
| TruthfulQA + judge-bias papers | pdf | `readings/general/` | why judges need calibration |
| langfuse/langsmith course repos | code | `generative-ai/coursera-references/` | hands-on tracing |
| Anthropic Eval Taxonomy · LLM-judge + annotation pages (wiki/eval, 16pp) | wiki | librarian | compiled harness designs |
| eval-harness.md · observability.md · agents-self-training.md | note | [../../notes/](../../notes/) | taxonomy + tracing + eval-driven training |
